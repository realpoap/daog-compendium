...
const Sidebar = () => {
	...
	return (
		<header className='sticky top-0 z-50 h-fit'>
			<section className='font-grenze dark:bg-base-200 mx-auto flex w-full flex-row items-center justify-between gap-4 bg-stone-100 p-2 shadow-md shadow-stone-900'>
