		...
		>
			{!isLoading ? (
				<span className='text-center'>
					{!isValid ? (
						<BiSolidLock className='icon-bakground-lg' />
					) : (
						<>{text}</>
					)}
				</span>
